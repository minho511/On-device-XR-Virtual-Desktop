...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    /// on the CPU.</para>
    /// <para>This is different from the  Background component, which efficiently displays the camera image on the screen.
    ...
    public class CpuImageSample : MonoBehaviour
    {
        ...
        public RenderTexture out_renderTexture //mm
        {
            get => m_renderTexture;
        ...
        unsafe void UpdateCameraImage()
        {
            ...
            //int resolution = 4096; //mm
            //out_renderTexture = new RenderTexture(resolution, resolution, 0); //mm
            //out_renderTexture.enableRandomWrite = true; //mm
            ...
            Graphics.Blit(m_CameraTexture, out_renderTexture); //mm
            // Set the RawImage's texture so we can visualize it.

            m_RawCameraImage.texture = m_CameraTexture;
            MySetAlgo.UpdateRenderedTexture();
         }
        ...
        static void UpdateRawImage(RawImage rawImage, XRCpuImage cpuImage, XRCpuImage.Transformation transformation, RenderTexture out_renderTexture)
        {
