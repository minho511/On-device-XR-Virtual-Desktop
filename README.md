...
2. **Hand Tracking & Gesture Recognition**
    ...
    - Gesture Recognition : a custom model was designed and trained using `PyTorch` with a dataset collected specifically for this project.
        <p align="center">
        <img src="./src/fig6.png" width=700>
        <img src="./src/fig5.png" width=700>
        </p>
        ...
        <p align="center">
        <img src="./src/fig3.png" width=700 style="margin-top:20px;"/>
        </p>
...
4. **Fish-eye Effect for Spatial Perception**
    <p align="center">
    <img src="./src/fig4.png" width=700  style="margin-left: 0px;"/>
    </p>
